...
/*
 * Color Picker component. It uses Spectrum Color Picker
 *
 */
class ColorPicker extends React.Component {
  ...
  componentDidMount() {
    $(findDOMNode(this.refs.colorPickerControl)).spectrum({
  ...
  componentDidUpdate() {
    $(findDOMNode(this.refs.colorPickerControl)).spectrum("set", this.props.value);
  }
  ...
  render() {
    return (
      <div style={{display:'inline-block'}} className={this.props.className}>
        { this.props.children }
        <input type='text' ref="colorPickerControl"/>
      </div>
    );
  }
}
